...
function Get-OrchestratoModel
{
    ...
    {
        bf orchestrator:basemodel:get -o "$outDirectory" --versionId pretrained.20210521.microsoft.dte.01.06.int.en.onnx | Out-Null
    }
    else
    {
        bf orchestrator:basemodel:get -o "$outDirectory" --versionId pretrained.20210608.microsoft.dte.01.06.int.unicoder_multilingual.onnx | Out-Null
    }
